                ...
                <div class="tabs-box">
                    ...
                    <div class="tabs-content">
                        <div class="tab active-tab" id="tab-1">
                            <div class="inner-box">
                                <h4>Sign up</h4>
                                <form action="{{ route('register') }}" method="post" class="default-form" id="user_register">
                                    @csrf
                        ...
                        <div class="tab" id="tab-2">
                            <div class="inner-box">
                                <h4>Sign up</h4>
                                <form action="{{ route('agentstore') }}" method="post" class="default-form" id="agent_register">
                                    @csrf
                                    <div class="form-group">
