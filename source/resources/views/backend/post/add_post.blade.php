                        ...
                        <form id="myForm" method="POST" action="{{ route('store.post') }}" class="forms-sample" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="blogcat_id" class="form-control @error('blogcat_id') is-invalid @enderror">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="short_descp" class="form-control @error('short_descp') is-invalid @enderror" rows="3"></textarea>
                                    @error('short_descp')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="long_descp" class="form-control @error('long_descp') is-invalid @enderror" id="tinymceExample" rows="10"></textarea>
                                    @error('long_descp')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input name="post_tags" id="tags" value="Realestate," class="form-control @error('post_tags') is-invalid @enderror" />
                                    @error('post_tags')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                <img id="showImage" class="rounded-circle" src="{{ url('upload/no_image.jpg') }}" width="50px" height="50" alt="profile">
                            </div>
