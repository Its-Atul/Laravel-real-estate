                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="lowest_price" class="form-control"value="{{ $property->lowest_price }}" placeholder="Enter Lowest Price (e.g., 4500000)">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label">Max Price </label>
                                        <input type="text" name="max_price" class="form-control" value="{{ $property->max_price }}" placeholder="Enter Max Price (e.g., 4500000)">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.property.thambnail') }}" id="myThambnail" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $property->id }}">
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.property.multiimage') }}" id="myMultiImage" enctype="multipart/form-data">
                            @csrf
                        ...
                        <form method="post" action="{{ route('store.new.multiimage') }}" id="myNewMultiImage" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.property.facilities') }}" id="myFacilityForm">
                            @csrf
                            <input type="hidden" name="id" value="{{ $property->id }}">
