                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="lowest_price" class="form-control" placeholder="Enter Lowest Price (e.g., 4500000)">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label">Max Price </label>
                                        <input type="text" name="max_price" class="form-control" placeholder="Enter Max Price (e.g., 4500000)">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
