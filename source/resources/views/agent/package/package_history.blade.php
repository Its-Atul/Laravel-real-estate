...
@section('title', 'All Package History')
@section('agent')
                        ...
                        <table id="dataTableExample" class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Package </th>
                                    <th>Invoice </th>
                                    <th>Amount ({{ $currency_symbol->currency_symbol }})</th>
                                    <th>Date </th>
                                    <th>Action </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td><img src="{{ (!empty($item->user->photo)) ? url('upload/admin_images/'.$item->user->photo) : url('upload/no_image.jpg') }}"
