            ...
            <div class="agents-block-one">
                <div class="inner-box mr-0">
                    <figure class="image-box">
                        <img src="{{ (!empty($agent->photo)) ? url('upload/admin_images/'.$agent->photo) : url('upload/no_image.jpg') }}" alt="" style="width:270px; height:330px;" >
                    </figure>
                    <div class="content-box">
                        <div class="upper clearfix">
                            ...
                            <ul class="social-list pull-right clearfix">
                                <li><a href="{{ $agent->facebook ?? 'javascript:void(0)' }}"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="{{ $agent->twitter ?? 'javascript:void(0)' }}"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="{{ $agent->instagram ?? 'javascript:void(0)' }}"><i class="fab fa-instagram"></i></a></li>
                                <li><a href="{{ $agent->youtube ?? 'javascript:void(0)' }}"><i class="fab fa-youtube"></i></a></li>
                            </ul>
                        </div>
                        <div class="text">
                            <p>
                                {{ $agent->about ?? 'Agent About Us' }}
                            </p>
                        </div>
                        <ul class="info clearfix mr-0">
                            <li><i class="fab fa fa-envelope"></i><a href="javascript:void(0)">{{ $agent->email ?? 'Email Address' }}</a></li>
                            <li><i class="fab fa fa-phone"></i><a href="javascript:void(0)">{{ $agent->phone ?? 'Phone Number' }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col">
                                <div class="left-column pull-left">
                                    <div class="group-title">
                                        <h3>Listing By {{ $agent->name ?? 'Agent Name'  }}</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                    ...
                                    @php $encryptedId = encrypt($item->id); @endphp
                                        <div class="deals-block-one">
                                            <div class="inner-box">
                                                <div class="image-box">
                                                    <figure class="image">
                                                        <img src="{{ asset($item->property_thambnail ?? '') }}" alt=""  style="width:300px; height:350px;">
                                                    </figure>
                                                    ...
                                                    @endif
                                                    <div class="buy-btn"><a href="javascript:void(0)">For {{ $item->property_status ?? '' }}</a></div>
                                                </div>
                                                <div class="lower-content">
                                                    <div class="title-text"><h4>
                                                        <a href="{{ url('property/details/'.$encryptedId.'/'.$item->property_slug) }}">{{ (strlen($item->property_name) > 0) ? substr($item->property_name, 0, 27): 'property name' }}</a>
                                                    </h4>
                                                </div>
                                                    <div class="price-box clearfix">
                                                        ...
                                                        <div class="author-box pull-right">
                                                            <figure class="author-thumb">
                                                                <img src="{{ (!empty($item->user->photo)) ? url('upload/admin_images/'.$item->user->photo) : url('upload/no_image.jpg') }}" alt="" width="50" height="50">
                                                                <span>{{ $item->user->name ?? '' }}</span>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    <p>{{ (strlen($item->short_descp) > 0) ? substr($item->short_descp, 0, 105). '..' : 'Short description' }}</p>
                                                    ...
                                                    <div class="other-info-box clearfix">
                                                        <div class="btn-box pull-left">
                                                            <a href="{{ url('property/details/'.$encryptedId.'/'.$item->property_slug) }}" class="theme-btn btn-two">See Details</a>
                                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 feature-block">
                                            <div class="feature-block-one">
                                                <div class="inner-box">
                                                    <div class="image-box">
                                                        <figure class="image">
                                                            <img src="{{ asset($item->property_thambnail ?? '') }}" alt=""  style="width:370px; height:250px;">
                                                        </figure>
                                                        <div class="batch"><i class="icon-11"></i></div>
                                                        @if($item->featured == 1)
                                                        <span class="category">Featured</span>
                ...
                <div class="default-sidebar agent-sidebar">
                    <div class="agents-contact sidebar-widget">
                        <div class="widget-title">
                            <h5>Contact To {{ $agent->name ?? 'Agent Name' }}</h5>
                        </div>
