@php
    ...
    $property_3 = App\Models\Property::where('state_id',$skip_state_3->id)->get();

    $encryptedId_0 = encrypt($skip_state_0->id);
    $encryptedId_1 = encrypt($skip_state_1->id);
    $encryptedId_2 = encrypt($skip_state_2->id);
    $encryptedId_3 = encrypt($skip_state_3->id);
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all illustration brand marketing software">
                    <div class="place-block-one">
                        <div class="inner-box">
                            ...
                            <div class="text">
                                <h4><a href="{{ route('state.details',$encryptedId_0) }}">{{  $skip_state_0->state_name ?? ''}}</a></h4>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all brand illustration print software logo">
                    <div class="place-block-one">
                        <div class="inner-box">
                            ...
                            <div class="text">
                                <h4><a href="{{ route('state.details',$encryptedId_1) }}">{{ $skip_state_1->state_name ?? ''}}</a></h4>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all illustration marketing logo">
                    <div class="place-block-one">
                        <div class="inner-box">
                            ...
                            <div class="text">
                                <h4><a href="{{ route('state.details',$encryptedId_2) }}">{{ $skip_state_2->state_name ?? ''}}</a></h4>
                ...
                <div class="col-lg-8 col-md-6 col-sm-12 masonry-item small-column all brand marketing print software">
                    <div class="place-block-one">
                        <div class="inner-box">
                            ...
                            <div class="text">
                                <h4><a href="{{ route('state.details',$encryptedId_3) }}">{{ $skip_state_3->state_name ?? ''}}</a></h4>
